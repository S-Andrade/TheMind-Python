    ...
    while True:
        ...
        if shared_dict["gazetarget"] == "condition":
            ...
            if  shared_dict["targetPlayer"] == "":
                print(str(shared_dict["player0"]) + "  " + str(shared_dict["player1"]))
                #MutualGaze
                if shared_dict["player0"] == "Robot" and (shared_dict["player1"] == "Center" or shared_dict["player1"] == "Tablet"):
                    with shared_data_lock:
                        shared_dict["targetPlayer"] = "player0"
                        player0 += 1
                
                elif shared_dict["player1"] == "Robot" and (shared_dict["player0"] == "Center" or shared_dict["player0"] == "Tablet"):
                    with shared_data_lock:
                        shared_dict["targetPlayer"] = "player1"
                        player1 += 1
                
                elif (shared_dict["player0"] == "Player" and shared_dict["player1"] == "Player") or (shared_dict["player0"] == "Robot" and shared_dict["player1"] == "Robot"):
                ...
                #JointAttention
                elif shared_dict["player0"] == "Player" and (shared_dict["player1"] == "Center" or shared_dict["player1"] == "Tablet"):
                    with shared_data_lock:
                        shared_dict["targetPlayer"] = "player1"
                        player1 += 1
                
                elif shared_dict["player1"] == "Player" and (shared_dict["player0"] == "Center" or shared_dict["player0"] == "Tablet"):
                    with shared_data_lock:
                        shared_dict["targetPlayer"] = "player0"
                        player0 += 1

                elif shared_dict["player0"] == "Robot" and shared_dict["player1"] == "Player":
                    with shared_data_lock:
                        shared_dict["targetPlayer"] = "player0"
                        player0 += 1
                
                elif shared_dict["player1"] == "Robot" and shared_dict["player0"] == "Player":
                    with shared_data_lock:
                        shared_dict["targetPlayer"] = "player1"
                        player1 += 1
                
                elif shared_dict["player0"] == "Center" and shared_dict["player1"] == "Center":
                    with shared_data_lock:
                        shared_dict["targetPlayer"] = "mainscreen"
